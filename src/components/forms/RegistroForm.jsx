...
import { HiOutlinePhone, HiOutlineLockClosed, HiOutlineEye, HiOutlineEyeSlash, HiOutlineHome } from 'react-icons/hi2';
import { Link } from 'react-router-dom';

const RegistroForm = ({ onRegistroSuccess, onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ general: 'Hubo un error al crear tu cuenta. Inténtalo de nuevo.' });
    } finally {
      setIsLoading(false);
    }
  };
